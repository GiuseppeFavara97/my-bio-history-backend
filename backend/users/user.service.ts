...
<<<<<<< HEAD:backend/src/users/user.service.ts
...
>>>>>>> origin/main:backend/users/user.service.ts
...
=======
<<<<<<< HEAD:backend/users/user.service.ts
...
>>>>>>> main:backend/src/users/user.service.ts
    async createUser(userDto: UserDto): Promise<User> {
